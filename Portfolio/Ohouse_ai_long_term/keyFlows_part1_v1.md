...
### User Story: Before vs. After

**BEFORE (Current Experience):**
> "I want to redesign my living room. The app asks me 'What's your style?' I don't know how to answer. Modern? Minimalist? Scandinavian? I browse for an hour, finding products I like, but I have no idea if they'll fit in my 3x4m space. I end up leaving frustrated."
> — Sarah, 32, homeowner

**AFTER (With Photo-Based Onboarding):**
> "I took a photo of my living room. The app instantly analyzed it and said: 'We see a wooden sofa, need lighting, storage, and an accent piece.' I selected the categories I wanted to improve. Two minutes later, I'm looking at products that actually fit MY space—not generic inspiration. I added 3 items to my cart instantly."
> — Sarah, 32, homeowner (same person, same session)

**What Changed:** 1 hour of research → 5 minutes. From abstract style questions → visual analysis of her actual space. From "will this fit?" doubt → instant confidence.
...
**BEFORE (Current Experience):**
> "I found a gray sofa I really like. The product photo shows it in a bright, minimalist warehouse setting. But my room is warmer, more traditional. Will it match? I can't tell. I check reviews, look at other photos, but nothing shows what it would look like in a REAL home like mine. I abandon the cart and keep browsing. Two days pass."
> — Marcus, 38, apartment renter

**AFTER (With PDP Visualization):**
> "I found the same gray sofa. One click and—boom—I see it in MY actual room (the photo I uploaded). It looks perfect. I can see how it positions against my existing furniture, the lighting matches, the scale is right. I swipe through 3 different placements. I can even see it in AR from my couch. I'm 100% sure. Checkout in 2 minutes."
> — Marcus, 38, apartment renter (same person, same session)

**What Changed:** 2 days of research, 8 abandoned carts → 2 minutes, 1 confident purchase. From imagination → proof. From "hope this works" → certainty.
...
**BEFORE (Current Experience):**
> "I'm scrolling through inspiring living room designs on Ohouse. This Scandinavian aesthetic is beautiful—clean lines, warm wood, soft textures. I save 5 photos. But then what? I can't afford to redecorate everything from scratch. I feel inspired but stuck. I close the app and move on. The photos sit in my 'saved' folder forever."
> — Lisa, 28, first-time furniture buyer

**AFTER (With Style Transfer):**
> "I'm scrolling and find that same Scandinavian design. I tap 'See this in your room.' My living room appears with the Scandinavian style applied. Some pieces match my budget, some don't. I tweak it—keep my existing coffee table, swap in the sofa and artwork that inspire me. I can see the transformation in real-time. I add 4 items to my cart that night. A week later, I buy Phase 2 items. Then I upload MY room to inspire others."
> — Lisa, 28, first-time furniture buyer (same person, 1 week engagement)

**What Changed:** Passive browsing → active creation → purchase → community contribution. From "that's nice but not for me" → "I can make this work in MY space."
...
**BEFORE (Current Experience):**
> "My living room feels dark even though I have two windows. I ask in the Q&A section: 'How can I brighten up my living room?' Someone responds with generic advice: 'Add mirrors and light colors.' That's not helpful. I Google 'dark living room solutions' and spend hours reading articles. I don't know what to buy."
> — Tom, 45, busy professional

**AFTER (With Visual Q&A + Community):**
> "I upload a photo of my dark living room and ask: 'How do I make this brighter without replacing everything?' Within 10 minutes, the system shows me 3 visualized solutions: (1) Add mirrors + lighting fixtures, (2) Paint accent wall light color + add floor lamp, (3) All of above. I see each option rendered in MY room. 50 people voted on which works best. I buy Option 2 that day. Three months later, I ask about adding storage—same process, same speed."
> — Tom, 45, busy professional (same person, multiple purchases over 3 months)

**What Changed:** Generic text advice → visual proposals + social proof. From confused → confident, from 8 hours research → 15 minutes, from 1 purchase → repeat purchases.
...
**BEFORE (Current Experience - Traditional):**
> "I'm moving into a new 2-bedroom apartment. I have a budget of $5,000 and zero design ideas. Do I hire an interior designer ($2,000-3,000)? Do I DIY and waste money on things I'll hate? I spend 3 weeks browsing, creating mood boards, second-guessing everything. My partner and I disagree on style. I order things, return them, order again. By move-in day, my apartment is half-furnished and I'm exhausted."
> — Emma, 26, new apartment

**AFTER (With Agentic Design):**
> "I opened the app and uploaded photos of my empty rooms + my budget ($5,000). I told the system: 'I like minimalist but warm, need functional home office, want it to feel grown-up but cozy.' The system showed me 3 complete design proposals. I gave feedback on the first: 'Too minimal, needs more color.' It refined 2 new versions. I loved one. The system said: 'Phase 1 ($2,500): foundation pieces. Phase 2 ($2,500): finishing touches.' I ordered Phase 1 before move-in. Phase 2 ships next month. I see my entire furnished space in AR before any of it arrives. I'm excited, not stressed."
> — Emma, 26, new apartment (same person, 2-phase purchase plan)

**What Changed:** 3 weeks of research → 1 hour. From doubt/disagreement → clarity/alignment. From scattered purchases → coordinated plan. From 50% furnished move-in → fully designed, phased execution.
...
**BEFORE (Current Experience):**
> "I finished decorating my apartment using the agentic design tool. It looks amazing. I post the photo on Instagram and get 50 likes from friends. But that's it. The app is done—I'm done. I don't return unless I'm redesigning another room. The platform has no reason to keep me engaged."
> — Emma, 26, finished with Phase 2 (same person from Flow 5)

**AFTER (With Community Loop):**
> "I finished decorating and uploaded my design to the Explore feed. Within a week, 200 people upvoted my design. Someone messaged: 'I love your bedroom aesthetic! Should I try the same style?' That gave me so much joy. I started browsing the Explore feed daily—seeing other people's designs, voting on my favorites. I got inspired by a minimalist Japanese aesthetic and thought: 'What if I redo my home office that way?' I created a new design variant. This time I bought the full set in Phase 1 because I was so confident. Over the next year, I've created 3 different room designs, bought thousands in products, and became a community 'design inspiration' person. Friends now ask for my recommendations."
> — Emma, 26, 1 year later (same person, 3 designs, $12,000+ LTV)

**What Changed:** One-time user → 12-month engagement → repeat purchases → community contributor. From "app is done" → daily habit → identity (I'm a design-inspiration person).
...
**BEFORE (Current Experience):**
> "I designed my perfect living room using an interior design app. It looks beautiful. Now I need to buy the furniture. The app shows me the products, but I have to go to 5 different websites to actually buy them—some are unavailable in my country, some are out of stock. The cart abandons 3 times because of friction. I end up buying only 60% of the design. My living room looks half-finished."
> — James, 35, project manager

**AFTER (With Integrated Shopping + Phased Purchasing):**
> "I designed my living room. One tap and I'm in the shopping interface. All products are right there, real prices, in-stock status. I see: 'Phase 1 (Must-haves): $2,300' and 'Phase 2 (Nice-to-haves): $1,800.' I'm tight on budget this month, so I buy Phase 1. The system sends me an AR walkthrough showing what my room will look like with just Phase 1 pieces. It looks GOOD. I see a payment plan option for Phase 2. In 2 months, I buy Phase 2 confidently because I've already lived with Phase 1. Everything coordinates perfectly."
> — James, 35, 2-phase purchase (same person, $4,100 over 2 months)

**What Changed:** Design → friction → abandonment → half-finished room → design → seamless shopping → phased confidence → complete room. From 1 transaction (incomplete) → 2 transactions ($4,100 total) over time.
