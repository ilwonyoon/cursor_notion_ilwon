...
## Context: From Near-Term to Standalone Agentic Experience

**Near-term approach** (Onboarding):
- Users upload a room photo, answer questions
- System generates a **personalized product feed** for browsing
- User manually discovers and assembles pieces

**Mid-term approach** (Standalone Agentic App):
- Users upload a room photo, answer questions
- System **generates complete design proposals** (3-4 candidates)
- User evaluates, gives feedback, iterates with AI
- **Core shift**: From "What to request?" to "How to give feedback?"
